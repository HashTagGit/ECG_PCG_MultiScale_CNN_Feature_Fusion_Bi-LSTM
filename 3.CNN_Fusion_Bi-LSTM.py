##=========================================================
#
#  CNN feature fusion Bi-LSTM network 
#
...
def MultiScaleCNNFusionBiLSTM():
    ...
    ecg_bilstm = Bidirectional(LSTM(256, return_sequences=True), name="ECG_BiLSTM")(ecg_drop2)
    ...
    pcg_bilstm = Bidirectional(LSTM(256, return_sequences=True), name="PCG_BiLSTM")(pcg_drop2)
    ...
    fusion_bilstm1 = Bidirectional(LSTM(256, return_sequences=True), name="Fusion_BiLSTM1")(fusion_bn)
